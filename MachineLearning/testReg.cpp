...
template<typename LEARNER> int testRegressor()
{
    ...
    string fExpStd = "RegReportExpStd" + toString(reportNumber) + ".csv";
    string fL1 = "RegReportL1" + toString(reportNumber) + ".csv";
    string fTimer = "RegReportTimer" + toString(reportNumber) + ".csv";
    string fCount = "RegeportFeature" + toString(reportNumber) + ".csv";
    ++reportNumber;
    for(int i = 0; i < data.getSize(); ++i)
    {
        ...
        cs.debug();
        /*addToCSV(Vector<string>(1, toString(cs.expStd)), fExpStd.c_str());
        addToCSV(Vector<string>(1, toString(cs.l1Err)), fL1.c_str());
